(function initWisePptAtlasAdapter(root, factory) {
  const api = factory();
...
})(typeof window !== 'undefined' ? window : globalThis, function createWisePptAtlasAdapter() {
  'use strict';
  ...
  // no longer form a coherent hierarchy. Snap them to Wise PPT semantic type roles
