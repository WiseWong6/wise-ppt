...
wrapper=slot.replace('width:460px','width:850px')
...
expect_fail template-geometry-drift '非关系模板几何漂移' browser
...
expect_fail missing-icon '图标不存在'
expect_fail forged-icon '图标几何与 redraw-v3 不一致'
echo "PASS deck contract v2 fixtures=17"
