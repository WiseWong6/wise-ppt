...
flowchart TD
    ...
    Fit -->|合| CopyFrame[复制整页帧作底稿<br/>只替换文案/数据/图标]
...
| 页面类型 | 走哪条路 | 说明 |
|---|---|---|
| **非关系页** | 直接套模板,不进关系/结构/组件流程 | 封面、目录、尾卡、Outro、章节隔页、金句页、粒子主角页、联络尾页 |
...
### 组件清洗结果(v9,历史快照;现役池以 routing-manifest 125 条为准)
...
- **一页只在一处说最重要的话**(v80):大字宣言/金句/焦点宣言页,主张已由页面本体承载;封面/隔页/金句/尾卡保持纯粹,金句页的出处行是内容,不是题注。
- 组件尺寸按"无标题后的完整版心"重算:内容区上缘从眉题带之下开始,下缘到题注之上,组件垂直居中其间,不按"有标题"的旧版心缩排(精确居中口径见 9.2-7)。

### 9.5 页面节奏(判断启发,不是机械间隔)

执行口径(结构重复间隔 ≥3 页且组件族不同、相邻页禁同结构、连续 3 页重密度警惕、大字页不接大字页)见 SKILL.md 红线"节奏"条,不再复制。此处只留分流阶段的判断启发:
