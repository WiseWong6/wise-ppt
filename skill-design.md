...
7. **可用高度内垂直居中**(v80):组件按内容包围盒在眉题底与题注顶之间(约 y160-900)垂直居中,逐页量 bbox 校准,不按画布中线估;页面没有题注时下缘取 .folio 之上。
...
- 组件尺寸按"无标题后的完整版心"重算:内容区上缘从眉题带之下(约 y160)开始,下缘到题注之上(约 y900),组件垂直居中其间,不按"有标题"的旧版心缩排。
