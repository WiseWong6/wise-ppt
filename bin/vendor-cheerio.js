...
// scripts/stubs/iconv-lite-stub.mjs
var iconv_lite_stub_exports = {};
__export(iconv_lite_stub_exports, {
  decode: () => decode,
  decodeStream: () => decodeStream,
  default: () => iconv_lite_stub_default,
  encodingExists: () => encodingExists
});
import { Transform } from "node:stream";
function assertUtf8(encoding) {
  if (encoding && !/^(?:utf-?8|us-ascii|ascii)$/i.test(String(encoding))) {
    throw new Error(`wise-ppt \u7CBE\u7B80\u6784\u5EFA\u4EC5\u652F\u6301 UTF-8 \u8F93\u5165\uFF0C\u9047\u5230\u7F16\u7801: ${encoding}`);
  }
}
function decode(buffer, encoding) {
  assertUtf8(encoding);
  const data2 = Buffer.isBuffer(buffer) ? buffer : Buffer.from(buffer);
...
var encodingExists, iconv_lite_stub_default;
var init_iconv_lite_stub = __esm({
  "scripts/stubs/iconv-lite-stub.mjs"() {
    encodingExists = (encoding) => /^(?:utf-?8|us-ascii|ascii)$/i.test(String(encoding));
    iconv_lite_stub_default = { decode, decodeStream, encodingExists };
  }
});

// node_modules/whatwg-encoding/lib/supported-names.json
var require_supported_names = __commonJS({
  "node_modules/whatwg-encoding/lib/supported-names.json"(exports, module) {
    module.exports = [
      "UTF-8",
      "IBM866",
      "ISO-8859-2",
...
var require_labels_to_names = __commonJS({
  "node_modules/whatwg-encoding/lib/labels-to-names.json"(exports, module) {
    module.exports = {
      "866": "IBM866",
...
var require_whatwg_encoding = __commonJS({
  "node_modules/whatwg-encoding/lib/whatwg-encoding.js"(exports) {
    "use strict";
    var iconvLite = (init_iconv_lite_stub(), __toCommonJS(iconv_lite_stub_exports));
